...
CREATE TABLE IF NOT EXISTS `article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` text,
  `info1` varchar(8) DEFAULT NULL,
  `info2` varchar(8) DEFAULT NULL,
  `author` text,
  `date` text,
  `imgUrl` text,
  `content` text,
...
INSERT INTO `article` (`id`, `title`, `info1`, `info2`, `author`, `date`, `imgUrl`, `content`) VALUES
(1, '脑洞', '脑洞大开？', '大脑上真有洞吗？', '中国数字科技馆', '2016.05.12', 'article_0', '其实，我们每个人刚出生时，就可以说是“脑洞大开”—生下来，脑袋上就自带两个“天窗”。这两个“天窗”是颅骨间的缝隙，分别被称为前囱( xin )门和后囱门。这两个囱门看起来像是发育不全，但却给了婴儿头骨一定的变形能力，使他们在出生时能更顺利地通过产道。这两个“脑洞”会随着人的发育自然闭合，后囱门在人出生后6一8周时就会闭合，前囱门在人出生后1一2岁的时候也会关上。如果闭合太早或者太晚，则可能意味着疾病。'),
(2, '三岁见老', '“三岁见老”', '这回事吗？', '就医160', '2016.05.25', 'article_1', '俗话说，“三岁见老”，其实并非毫无依据的，从埃里克森的“心理社会发展理论”来看，儿童在三岁左右的时候便开始形成自己的行为习惯，习惯一旦养成，要改是很难很难的。都说养大一个孩子不容易，培养好一个孩子更不容易，究竟，小朋友的心理变化是怎样的一段奇妙之旅呢？'),
(3, '药不能停', '“药不能停”，', '吃药也要讲究方法', '壹心理', '2016.05.26', 'article_2\r\n', '在很多人看来，和服药有关的众多事项中，最不需要注意的就是服药的次数和时间了，毕竟“药物只要吃下去就会治病，又何必在意什么时候吃？”这实际上是一种不折不扣的谬论，因为药品说明书上记载的用药次数、时间都不是空穴来风，如果不能做到遵守这些注意事项，轻则会影响药物的治疗效果，严重时甚至会产生额外的不良反应。药物的服药次数往往取决于它在血浆中的半衰期（即血浆浓度因人体的清除效应而下降一半所需的时间），因为只有血浆中的药物浓度达到了足以治疗疾病的水平，药物才能发挥正常效果。由于很多药物单次服用后的半衰期很短，因此为了令药物在服药期间能持续发挥效果，它们需要一天两次甚至多次服药；而对那些具有很长半衰期，或是能够在血浆浓度下降后依然会存在疗效（即“剂量后效应”）的药物，很多时候可能一天一次用药即足矣。至于服药时间上的安排，很多情况下这一点取决于药物及其所治疗疾病的特性。例如因肾上腺疾病而需要补充皮质类固醇的患者，往往需要在清晨和下午各服一剂药物，以模拟激素本身的分泌特点；需要控制餐后血糖的糖尿病患者，通常会在餐前使用降糖药物，这样既能够治疗餐后升高的血糖，又规避了降糖药物导致低血糖的作用。');
