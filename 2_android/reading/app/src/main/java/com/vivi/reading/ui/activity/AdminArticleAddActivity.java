...
public class AdminArticleAddActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if (title.length() == 0 || info.length() == 0 || content.length() == 0){
            Toast.makeText(AdminArticleAddActivity.this, "请把信息填写完整", Toast.LENGTH_SHORT).show();
        }
        else {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, ConstUtils.BASEURL + "getarticletype.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (result != 0){
                            Toast.makeText(AdminArticleAddActivity.this, "网络连接失败", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Gson gson = new Gson();
                            ...
                            for (int i = 0; i < items.size(); i++){
                                ...
                                if (type.getId() == typeId) position = i;
                            }
                            ArrayAdapter<String> adapter = new ArrayAdapter<>(AdminArticleAddActivity.this,android.R.layout.simple_spinner_item, arrayList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AdminArticleAddActivity.this, "网络连接超时", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private StringRequest setArticle(final String title, final String info, final String content) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, ConstUtils.BASEURL + "addarticle.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        int result = 0;
                        ...
                        if (result != 0){
                            ...
                            Toast.makeText(AdminArticleAddActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }, new Response.ErrorListener() {
